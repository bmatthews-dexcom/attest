...
`~/.config/opencode/scripts/validators/validate-mermaid.sh`; mechanical issues auto-repairable
...
bash ~/.config/opencode/scripts/validators/validate-mermaid.sh . <dir>  # gate (uses mmdc to truly render if installed)
```
