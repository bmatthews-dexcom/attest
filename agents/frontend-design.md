...
**Run the validator:**
```bash
bash ~/.config/opencode/scripts/validators/validate-design-system.sh .
```
...
- Run `bash ~/.config/opencode/scripts/validators/validate-vendor-provenance.sh` after vendoring
