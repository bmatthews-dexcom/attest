...
```
bash(command="bash ~/.config/opencode/scripts/validators/validate-phase-gate.sh phase-0 . ; \
              bash ~/.config/opencode/scripts/validators/validate-phase-gate.sh phase-1 . ; ...")
```
