...
- `~/.config/opencode/scripts/validators/validate-erd-coverage.sh` — domain coverage (auto-run when relevant)
...
**Run the validator:**
```bash
bash ~/.config/opencode/scripts/validators/validate-erd-coverage.sh .
```
